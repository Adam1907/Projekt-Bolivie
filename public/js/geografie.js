...
$(function(){
    ...
    $("#svg14 rect").on('click', function(){
        ...
        $("#card-main").slideUp(500, function () {
            ...
            $('.card-pic').html(`<img src="images/${city.pic}" alt="${city.city}" class="img-fluid">`);
         });
    ...
    $("#svg14 path").on('click', function(){
        ...
        $("#card-main").slideUp(500, function () {
            ...
            $('.card-pic').html(`<img src="images/${region.pic}" alt="${region.name}" class="img-fluid">`);
         });
        $("#card-main").slideDown(500);
    });  
})